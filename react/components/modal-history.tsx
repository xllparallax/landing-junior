...
export function ModalHistory({
  ...
  return (
    <div className={styles.modalOverlay} onClick={closeModal}>
      <div className={styles.modalContainerjunior}>
        <div className={styles.imgTeam} />
        <div
          className={styles.modalContentjunior}
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header del Modal */}
          <div className={styles.modalHeaderJunior}>
            <div>
              <h2 className={styles.modalTitle}>Historia del Junior FC</h2>
              <p className={styles.modalSubtitle}>
                "Junior es más que un equipo, es un fenómeno sociológico, un
                sentir del pueblo barranquillero."
              </p>
            </div>
            <img
              src="/arquivos/ESCUDO_JUNIOR.png"
              alt="Escudo_Junior"
              className={styles.logoJunior}
            />
          </div>
                    ...
                    if (paragraph.includes('**') && paragraph.includes(':')) {
                      ...
                      return (
                        <div key={index} className={styles.listSection}>
                          <h4 className={styles.listTitleJunior}>
                            {title.replace(/\*\*/g, '')}
                          </h4>
          ...
          <div className={styles.modalFooter}>
            <div className={styles.modalFooterContent}>
              <div className={styles.modalFooterInfo}>
                <strong>Fundado:</strong> 7 de agosto de 1924 | 10 títulos de
                liga
              </div>
